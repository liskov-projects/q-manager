    ...
    <div className="p-2">
      <div className="flex justify-between">
        ...
        <Button
          ...
          className={`mb-4 mx-4 py-1 px-2 ${showAlternateView ? "bg-tennis-200 text-shell-300 border-shell-300 border-2" : "bg-bluestone-200 text-shell-50"} text-shell-50 hover:text-shell-300 hover:bg-tennis-200 rounded position-center rounded`}
        >
          {showAlternateView ? "Show Detailed View" : "Show Grid View"}
        </Button>
        <Button
          className={`mb-4 mx-4 py-1 px-2 ${showsFavourites ? "bg-tennis-200 text-shell-300 border-shell-300 border-2" : "bg-bluestone-200 text-shell-50"} text-shell-50 hover:text-shell-300 hover:bg-tennis-200 rounded position-center rounded`}
